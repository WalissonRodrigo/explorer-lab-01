...
function onChangeCVC(event) {
  ccCVC.textContent = event.target.value
}
...
function onChangeExpirationDate(event) {
  ccExpirationDate.textContent = event.target.value
}
...
function onChangeHolderName(event) {
  ccHolder.textContent = event.target.value
}
...
function onChangeCardNumber(event) {
  ccNumber.textContent = event.target.value
}
